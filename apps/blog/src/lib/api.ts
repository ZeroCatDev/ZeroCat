...
import { createBrowserAuthClient } from "@zerocat/auth-core";
...
export const refreshStoredAuthToken = authClient.refreshStoredAuthToken;
export const getFreshAuthToken = authClient.getFreshAuthToken;
...
export async function authedFetchResponse(
  ...
  return authClient.authedFetch(path, init, token);
}
