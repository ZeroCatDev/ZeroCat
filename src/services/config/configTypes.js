...
export const CONFIG_TYPES = {
    ...
    "mirror40code.incremental.max_scan": {
        type: "number",
        required: false,
        default: 5000,
        description: "增量扫描新用户时最多向后探测的ID数量",
        transform: typeTransformers.number,
        validate: (value) => value >= 1,
    },
    "mirror40code.incremental_projects.max_scan": {
        type: "number",
        required: false,
        default: 5000,
        description: "增量扫描新项目时最多向后探测的ID数量",
        transform: typeTransformers.number,
        validate: (value) => value >= 1,
    },
    ...
    "mirror40code.periodic.enabled": {
        ...
        required: false,
        default: true,
        description: "是否启用40code定期增量同步",
        transform: typeTransformers.boolean,
    },
    "mirror40code.periodic.incremental_users.enabled": {
        type: "boolean",
        required: false,
        default: true,
        description: "是否启用40code增量新用户同步任务",
        transform: typeTransformers.boolean,
    },
    "mirror40code.periodic.incremental_users.interval_ms": {
        type: "number",
        required: false,
        default: 600000,
        description: "40code增量新用户同步间隔(毫秒)",
        transform: typeTransformers.number,
        validate: (value) => value >= 60000,
    },
    "mirror40code.periodic.incremental_projects.enabled": {
        type: "boolean",
        required: false,
        default: true,
        description: "是否启用40code增量新项目同步任务",
        transform: typeTransformers.boolean,
    },
    "mirror40code.periodic.incremental_projects.interval_ms": {
        type: "number",
        required: false,
        default: 600000,
        description: "40code增量新项目同步间隔(毫秒)",
        transform: typeTransformers.number,
        validate: (value) => value >= 60000,
    },
